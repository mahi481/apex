...
const pressReleases = [
  {
    ...
    image: "/placeholder.svg?height=400&width=800&text=Cardiac+Care+Unit",
...
The Cardiac Care Unit is now fully operational and accepting patients. For appointments and consultations, please contact our cardiac care department.`,
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=800&text=Health+Camp",
...
Based on the success of this camp, Apex Hospital plans to organize similar health camps in other districts throughout the year.`,
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=800&text=NABH+Accreditation",
    content: `Apex Hospital has successfully achieved NABH (National Accreditation Board for Hospitals) accreditation, demonstrating our commitment to maintaining the highest standards in healthcare quality and patient safety.

The NABH accreditation process involved:
• Comprehensive evaluation of all hospital departments
• Assessment of patient care protocols
• Review of safety and quality measures
• Evaluation of staff training and competency
• Analysis of patient satisfaction metrics

This accreditation places Apex Hospital among the elite healthcare institutions in India that meet international standards of healthcare delivery. The rigorous evaluation process covered all aspects of hospital operations, from clinical care to administrative processes.

"Receiving NABH accreditation is a testament to our team's dedication to excellence," said the Hospital Administration. "This recognition validates our commitment to providing safe, effective, and patient-centered care."

The accreditation is valid for three years and requires continuous monitoring and improvement of healthcare standards. Apex Hospital will undergo regular assessments to maintain this prestigious certification.`,
    author: "Hospital Administration",
    tags: ["NABH Accreditation", "Quality Healthcare", "Patient Safety"],
  },
]
