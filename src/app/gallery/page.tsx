...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    // Medical Staff
    {
      ...
      description: "Dr. Rajesh Sharma - Leading our medical team",
       image: "/images/main.JPG",
    },
    { id: 37, category: "staff", title: "Cardiology Team", description: "Expert cardiologists and cardiac surgeons", image: "/images/main.JPG", },
    { id: 38, category: "staff", title: "Nursing Staff", description: "Dedicated nurses providing compassionate care", image: "/images/main.JPG", },
    {
      id: 39,
      category: "staff",
      title: "Emergency Team",
      description: "24/7 emergency response medical professionals",
       image: "/images/main.JPG",
    },
    {
      id: 40,
